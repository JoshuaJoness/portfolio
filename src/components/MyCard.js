...
const MyCard = ({ project }) => {
  ...
  useEffect(() => {
    switch (project.projectTitle) {
      case "Zen Chat":
        return setFontFamily("'Concert One', cursive");
      case "Airbnb Clone":
        return setFontFamily("'Knewave', cursive");
      case "Fleet Tracker":
        return setFontFamily("'Balsamiq Sans', cursive");
      case "Calorie Calulator":
        return setFontFamily("'Happy Monkey', cursive");
      default:
        return setFontFamily("'Pacifico', cursive");
    }
  }, []);
      ...
      <CardContent>
        <center>
          <Typography gutterBottom variant="h5" component="h2">
            <a href={project.projectLink} target="_blank">
              <h1
                style={{ fontFamily: fontFamily, color: "#F6C28B" }}
        ...
        >
          ...
          <div style={{ height: "100px", display: "flex" }}>
            {project.projectLinks.map((link, index) => {
              if (link.includes("github")) {
                return (
                  <a style={styles.link} href={link} target="_blank">
          ...
          >
            <center>
              <b
                style={{ fontFamily: "'Baloo 2', cursive", fontSize: "1.7rem" }}
              >
                Description
              </b>
            </center>
